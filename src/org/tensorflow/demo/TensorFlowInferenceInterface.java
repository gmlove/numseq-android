...
/**
 * Copied from tensorflow source code. Added an initializeModel method to enable model initializer.
 *
...
public class TensorFlowInferenceInterface {
  ...
  public int initializeModel(String initializerName) {
    runner.addTarget(initializerName);
    // Run the session.
    try {
      if (enableStats) {
